...
const waypointsMatch = content.indexOf('export const WAYPOINTS: Waypoint[] = [');
const endMatch = content.indexOf(']', waypointsMatch);
const wpStr = content.substring(waypointsMatch + 'export const WAYPOINTS: Waypoint[] = '.length, endMatch + 1);
